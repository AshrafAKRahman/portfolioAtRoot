        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <span className="navbar-text">
            <div className="social-icon">
                <a id="linkedin-icon" href="https://www.linkedin.com/in/ashraf-a-rahman-b7b508120/" rel="noreferrer" target="_blank"><img src={navIcon1} alt=""/></a>
                <a href="https://github.com/AshrafAKRahman" rel="noreferrer" target="_blank"><img src={navIcon2} alt=""/></a>
            </div>
          </span>
        </Navbar.Collapse>
      </Container>
