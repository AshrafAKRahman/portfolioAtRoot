                ...
                <Col>
                    <div className="skill-bx">
                        <h2 className="black-header"> Technological Skills </h2>
                            <p>Below is a brief overview of the technologies i am most comfortable working with for full stack development. I am consistently developing these skills and will adding C#, PHP and Vue shortly</p>
